...
export type ILayer = IMediaLayer |
	ITemplateLayer |
	IHtmlPageLayer |
	IInputLayer |
	IRouteLayer |
...
export interface NextUpMedia extends NextUpBase, ILayerBaseBase, IMediaLayerBase {
	content: LayerContentType.MEDIA
	auto?: boolean
}
export interface NextUpHTML extends NextUpBase, ILayerBaseBase, IHtmlPageLayerBase {
	content: LayerContentType.HTMLPAGE
	auto?: boolean
}
export interface NextUpInput extends NextUpBase, ILayerBaseBase, IInputLayerBase {
	content: LayerContentType.INPUT
	auto?: boolean
}
export interface NextUpRoute extends NextUpBase, ILayerBaseBase, IRouteLayerBase {
	content: LayerContentType.ROUTE
	auto?: boolean
