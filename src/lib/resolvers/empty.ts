...
import { State, LayerContentType, Transition, ITemplateLayer } from '../api'
...
function resolveEmptyState (
	...
	if (
		oldLayer.nextUp &&
		!newLayer.nextUp &&
		compareAttrs(oldLayer.nextUp, newLayer, ['media'])
	) {
		let prevClearCommand = _.find(diffCmds.cmds, (cmd) => {
